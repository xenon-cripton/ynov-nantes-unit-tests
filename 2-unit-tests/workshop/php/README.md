...
Laissez-moi vous présenter notre système :
...
Le lead dev est passé sur le code et il n'est pas sur qu'on respecte bien les spécifications.
Pour le rassurer on va devoir ajouter des tests unitaires pour chaque consigne donnée dans les spécifications